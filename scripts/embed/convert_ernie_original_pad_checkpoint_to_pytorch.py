...
# encoding: utf-8
"""代码来源：ChineseGLUE
https://github.com/nghuyong/ERNIE-Pytorch；可直接下载
1、下载ERNIE 1.0项目：https://github.com/PaddlePaddle/ERNIE/tree/repro
2、安装依赖：pip install paddlepaddle-gpu==1.5.0.post87 -i https://pypi.douban.com/simple/
3、引入ernie项目
4、下载ERNIE_1.0_max-len-512：https://ernie.bj.bcebos.com/ERNIE_1.0_max-len-512.tar.gz
"""
import collections
import os
import sys
...
sys.path.insert(0, './data/temp/ERNIE-repro/ernie')
...
if __name__ == "__main__":
    ...
    parser.add_argument("--init_pretraining_params", default='./data/temp/ERNIE_1.0_max-len-512/params', type=str, help=".")
    parser.add_argument("--ernie_config_path", default='./data/temp/ERNIE_1.0_max-len-512/ernie_config.json', type=str, help=".")
    parser.add_argument("--output_dir", default='./data/embedding/ERNIE_1.0_max-len-512_pytorch', type=str, help=".")
